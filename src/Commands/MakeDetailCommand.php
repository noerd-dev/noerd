...
class MakeDetailCommand extends Command
{
    use GeneratesResourceFiles;

    protected $signature = 'noerd:make-detail {model : Full model class path} {--app= : App name (e.g. crm)}';

    protected $description = 'Generate a detail Blade file with YAML from model columns';
    ...
    public function handle(): int
    {
        ...
        try {
            $this->createDetailBlade();
            $this->createDetailYaml();
            $this->addDetailRoute();
