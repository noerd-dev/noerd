 ...
 *
 * Consulted by StaticConfigHelper right after Yaml::parse() for every list,
 * detail and page config. The core binding is a no-op (NullLayoutOverrideResolver); an
...
{
    /**
     * @param  'list'|'detail'|'page'|string  $viewType
     * @param  string  $component  the getListConfig()/getComponentFields()/getPageFields() key (e.g. 'customers-list')
