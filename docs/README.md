...
- [Create an App](create-app.md) - Create your first tenant app
- [Create Navigation](navigation.md) - Define app navigation in YAML
- [Create a List View](list-view.md) - Build list pages with tables
- [Create a Detail View](detail-view.md) - Build detail/edit pages with forms
