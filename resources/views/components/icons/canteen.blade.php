...
<svg class="nc-icon mx-auto"  xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 48 48"><title>barbecue-tools</title>
    <g fill="#333" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="10">
        ...
        <rect x="28" y="2" fill="none" stroke="#333" stroke-width="2" width="16" height="16"></rect>
        <path fill="none" stroke="#333" stroke-width="2" d="M16,30H8v12 c0,2.2,1.8,4,4,4h0c2.2,0,4-1.8,4-4V30z"></path>
        <line fill="none" stroke="#333" stroke-width="2" x1="12" y1="30" x2="12" y2="18"></line>
        <path fill="none" stroke="#333" stroke-width="2" d="M18,2v10c0,3.3-2.7,6-6,6h0 c-3.3,0-6-2.7-6-6V2"></path>
    </g>
</svg>
</div>
